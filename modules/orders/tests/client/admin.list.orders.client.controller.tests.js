(function () {
  ...
  describe('Admin Orders List Controller Tests', function () {
    // Initialize global variables
    var OrdersAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _OrdersService_) {
      ...
      $httpBackend.whenGET('/modules/orders/client/views/list-orders.client.view.html').respond(200, '');
      ...
      OrdersAdminListController = $controller('OrdersAdminListController as vm', {
        $scope: $scope
      });
